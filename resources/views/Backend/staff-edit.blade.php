    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">View Staff Details</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            <li class="breadcrumb-item"><a href="#" class="text-muted">Staff</a>
                            </li>
                            <li class="breadcrumb-item text-muted active" aria-current="page">View Staff Details
                            </li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('staff.update', ['id' => $staff->Staff_Id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            @if (session('error'))
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <input type="text" id="Staff_Name" name="Staff_Name"
                                                        ...
                                                        required placeholder="Full Name" value="{{ $staff->Staff_Name }}">
                                                    <div id="staffNameError" class="text-danger"></div>
                                                    @error('Staff_Name')
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" id="Staff_HP" name="Staff_HP"
                                                        class="form-control @error('Staff_HP') is-invalid @enderror"
                                                        required placeholder="Phone Number" value="{{ $staff->Staff_HP }}">
                                                    @error('Staff_HP')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" id="Staff_Address" name="Staff_Address"
                                                        class="form-control @error('Staff_Address') is-invalid @enderror"
                                                        placeholder="Address" value="{{ $staff->Staff_Address }}">
                                                    @error('Staff_Address')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
