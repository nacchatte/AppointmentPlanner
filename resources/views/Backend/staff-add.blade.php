    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Add Staff</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            <li class="breadcrumb-item"><a href="index.html" class="text-muted">Staff</a>
                            </li>
                            <li class="breadcrumb-item text-muted active" aria-current="page">Add Staff
                            </li>
                        </ol>
                    </nav>
                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <input type="text" id="Staff_HP" name="Staff_HP"
                                                        ...
                                                        required placeholder="Phone Number" minlength="10">
                                                    @error('Staff_HP')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
