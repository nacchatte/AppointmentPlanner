$(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (chartElement) {
            ...
            var chartSeries = JSON.parse(chartElement.getAttribute('data-chart-series'));
            console.log(chartLabels);
            console.log(chartSeries);
            // Check if the data is not null before creating the chart
            if (chartLabels !== null && chartSeries !== null) {
